...
Inserir hóspede novo sem histórico estada
    ...
    Sleep                           3 seconds
    Move Mouse                      208   331
    Input Text                      ${IMAGE_SOBRENOME}  ${HOSP_RECEP_0601.sobrenome}
    Move Mouse                      323   331
    Input Text                      ${IMAGE_NOME}       ${HOSP_RECEP_0601.nome}
    Sleep                           1 seconds
    Move Mouse                      434   331
    Input Text                      ${IMAGE_EMAIL}      ${HOSP_RECEP_0601.email}
    Sleep                           2 seconds
    ...
    Input Text                      ${IMAGE_TEXT}       ${HOSP_RECEP_0601.cidade}
    ...
    Mouse Click                     686   237
    Input Text To Textbox           ${IDIOMA[0]}        ${HOSP_RECEP_0601.idioma}
    Click Button                    ${BUTTON_CONFIRMAR}
    @{RESINDIVIDUAL}                Get Application Windows
    Attach Window                   ${RESINDIVIDUAL[0]}
    Move Mouse                      409   409
    Input Text                      ${IMAGE_DATANASC}   ${HOSP_RECEP_0601.datanasc}
    Mouse Click                     741   341
    @{RESINDIVIDUAL}                Get Application Windows
    Attach Window                   ${RESINDIVIDUAL[0]}
...
Preencher informações e confirmar a reserva
    ...
    Input Text To Textbox           ${DOC_CONFIRM[0]}   ${HOSP_RECEP_0601.doc}
    Click Button                    ${BUTTON_CONFIRMAR}
    @{RESINDIVIDUAL}                Get Application Windows
    Attach Window                   ${RESINDIVIDUAL[0]}
    Move Mouse                      208   508
    Input Text                      ${IMAGE_NUMERO}     ${HOSP_RECEP_0601.email}
...
Cadastrar informações do hóspede
    ...
    Mouse Click                     260   205
    Input Text                      ${IMAGE_NUMERODOC}  ${HOSP_RECEP_0601.cpf}
    Mouse Click                     58    260
    Input Text                      ${IMAGE_CEP}        ${HOSP_RECEP_0601.cep}
    Move Mouse                      348   258
    Sleep                           1 seconds
    Input Text                      ${IMAGE_NUMEROEND}  ${HOSP_RECEP_0601.numend}
    Sleep                           2 seconds
