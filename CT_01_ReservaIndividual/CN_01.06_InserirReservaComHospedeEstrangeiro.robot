...
*** Test Case ***
Test Case 01.06: Inserir Reserva com Hospede Estrangeiro
...
Inserir hóspede estrangeiro novo sem histórico estada
    ...
    Input Text                      ${IMAGE_TEXT}       ${DADOSHOSPESTR_RESIND.cidade}
    ...
    Mouse Click                     686    237
    Input Text To Textbox           ${IDIOMA[0]}        ${DADOSHOSPESTR_RESIND.idioma}
    Click Button                    ${BUTTON_CONFIRMAR}
    @{RESINDIVIDUAL}                Get Application Windows
    Attach Window                   ${RESINDIVIDUAL[0]}
    Move Mouse                      409    409
    Input Text                      ${IMAGE_DATANASC}   ${DADOSHOSPESTR_RESIND.datanasc}
    Mouse Click                     741    341
    @{RESINDIVIDUAL}                Get Application Windows
    Attach Window                   ${RESINDIVIDUAL[0]}
...
Preencher informações e confirmar a reserva
    ...
    Input Text To Textbox           ${DOC_CONFIRM[0]}   ${DADOSHOSPESTR_RESIND.doc}
    Click Button                    ${BUTTON_CONFIRMAR}
    @{RESINDIVIDUAL}                Get Application Windows
    Attach Window                   ${RESINDIVIDUAL[0]}
    Move Mouse                      208    508
