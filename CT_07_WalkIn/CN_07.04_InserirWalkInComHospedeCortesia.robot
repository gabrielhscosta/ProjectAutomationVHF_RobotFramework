...
*** Test Case ***
Test Case 07.04: Inserir um Walk-in com Hospede Cortesia
...
Preencher os campos obrigatórios para gerar orçamento da reserva
    ...
    Input Text                      ${IMAGE_TEXT}       ${DADOS_RES.uh070104}
...
Cadastrar informações do hóspede
    ...
    Mouse Click                     260    205
    ${CPF_HOSPCORT_WALKIN}          FakerLibrary.cpf
    Input Text                      ${IMAGE_NUMERODOC}  ${CPF_HOSPCORT_WALKIN}
    Mouse Click                     58     260
